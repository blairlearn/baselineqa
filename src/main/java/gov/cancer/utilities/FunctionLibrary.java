 ...
 *
 * "Wait for Navigation" methods should be moved to a suitable class in gov.cancer.framework
 ...
 * 		should be deleted, or else moved to a suitable helper class in gov.cancer.framework.
 *
 */
@Deprecated
