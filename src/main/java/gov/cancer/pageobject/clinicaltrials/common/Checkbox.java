package gov.cancer.pageobject.clinicaltrials.common;
...
public class Checkbox {
  ...
  public void checkCheckbox(String id) {
    ...
    js.executeScript("var x=document.getElementById('" + id + "');x.style.display='inline';x.click();x.checked=true;");
  ...
  public void uncheckCheckbox(String id) {
    JavascriptExecutor js = (JavascriptExecutor) browser;
    js.executeScript("var x=document.getElementById('" + id + "');x.style.display='inline';x.checked=false;");
    Actions action = new Actions(browser);
    /// action.pause(500);
  }
