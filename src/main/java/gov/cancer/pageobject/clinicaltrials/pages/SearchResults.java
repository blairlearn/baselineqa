...
/**
 * Represents the Clinicial Trial Search results page. NOTE: Basic and advanced
 * search use the same results page, so there's only one class.
 */
public class SearchResults extends ClinicalTrialPageObjectBase {
  ...
  public SearchResults(WebDriver browser, ClinicalTrialPageObjectBase decorator)
