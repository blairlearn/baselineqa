 ...
 * (https://en.wikipedia.org/wiki/Decorator_pattern) to separate behaviors (e.g.
 * suppress vs. allowing the pro-active chat prompt) into behavior-specific
 * classes, separate from the page objects.
 */
public class ClinicalTrialPageObjectBase extends PageObjectBase {
  ...
  public ClinicalTrialPageObjectBase(WebDriver browser, ClinicalTrialPageObjectBase decorator)
